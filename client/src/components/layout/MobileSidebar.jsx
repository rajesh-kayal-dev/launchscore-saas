  ...
  return (
     <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden p-2 rounded-lg bg-[#1a1a1a] border border-white/10 text-white"
      >
      ...
      <div
        className={cn(
          'fixed top-0 left-0 h-screen w-64 bg-[#1a1a1a] border-r border-white/5 flex flex-col z-40 transform transition-transform duration-300 lg:hidden',
